...
class Database:
    def search_ads(self, keyword):
        # Implement the search functionality based on the keyword
        # and return a list of ads matching the search criteria
        # For example:
        matching_ads = []
        for ad in all_ads:
            if keyword.lower() in ad.title.lower() or keyword.lower() in ad.description.lower():
